...
vim.env.PATH = vim.env.PATH .. (is_windows and ";" or ":") ..
...
autocmd("FileType",
        {pattern = "alpha", callback = function() vim.opt.laststatus = 0 end})

autocmd("BufUnload",
        {buffer = 0, callback = function() vim.opt.laststatus = 3 end})
